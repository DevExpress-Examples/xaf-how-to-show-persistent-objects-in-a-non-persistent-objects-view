...
namespace ComplexDialogSample.Module.BusinessObjects {
    ...
    public class Office : BaseObject {
        ...
        public string Index {
            get { return GetPropertyValue<string>("Index"); }
            set { SetPropertyValue<string>("Index", value); }
        }
        public string OccupiedBy {
            get { return GetPropertyValue<string>("OccupiedBy"); }
            set { SetPropertyValue<string>("OccupiedBy", value); }
        }
    }
    ...
    public class Order : BaseObject {
        ...
        public Office Office {
            get { return GetPropertyValue<Office>("Office"); }
            set { SetPropertyValue<Office>("Office", value); }
        }
        public Service Service {
            get { return GetPropertyValue<Service>("Service"); }
            set { SetPropertyValue<Service>("Service", value); }
        }
