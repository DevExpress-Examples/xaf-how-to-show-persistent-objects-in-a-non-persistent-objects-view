...
Namespace ComplexDialogSample.Web
	...
	Partial Public Class ComplexDialogSampleAspNetApplication
		...
		Private Sub ComplexDialogSampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
			...
			Else
				Dim message As String = "The application cannot connect to the specified database, because the latter doesn't exist or its version is older than that of the application." & vbCrLf &
					...
					"or manually create team database using the 'DBUpdater' tool." & vbCrLf &
...
'ORIGINAL LINE: this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.ComplexDialogSampleAspNetApplication_DatabaseVersionMismatch);
