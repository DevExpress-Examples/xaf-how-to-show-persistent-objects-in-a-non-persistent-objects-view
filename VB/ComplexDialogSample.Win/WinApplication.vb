...
Namespace ComplexDialogSample.Win
	...
	Partial Public Class ComplexDialogSampleWindowsFormsApplication
		...
		End Sub
		Private Sub ComplexDialogSampleWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles Me.CustomizeLanguagesList
			...
			End If
		End Sub
		Private Sub ComplexDialogSampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
