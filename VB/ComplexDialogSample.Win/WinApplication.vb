...
Namespace ComplexDialogSample.Win
    ...
    Public Partial Class ComplexDialogSampleWindowsFormsApplication
        ...
        Private Sub ComplexDialogSampleWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub ComplexDialogSampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
